...
//   return (
//     <div
//       className={`fixed inset-0 z-50  bg-opacity-40 flex items-center justify-center p-4 transition-transform ease-in-out duration-300  ${
//         show
...
//                 ))}
//                 <li
//                   className="px-4 py-2 text-teal-600 hover:underline cursor-pointer"
...
export default function AddTransactionModal({
  ...
  const handleAddCategory = () => {
    ...
    const newCategory = { name: newCatName, type: newCatType };
    const updatedCategories = [...customCategories, newCategory];
    setCustomCategories(updatedCategories);
    localStorage.setItem("customCategories", JSON.stringify(updatedCategories));
    setNewCatName("");
    setNewCatType("Expenses");
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-opacity-40 flex items-center justify-center p-4 transition-transform ease-in-out duration-300  backdrop-blur-xs ${
        show
          ? "opacity-100 scale-100 translate-y-0"
          : "opacity-0 scale-90 translate-y-full"
      }`}
      ...
      >
        ...
        {newCatModalOpen && (
          <div className="fixed inset-0  flex items-center justify-center z-50 backdrop-blur-xs">
            <div
              className={`bg-white p-6 rounded-xl w-80 border-2 ${
                isPink
                  ? "border-pink-500"
                  : isOrange
                  ? "border-orange-500"
